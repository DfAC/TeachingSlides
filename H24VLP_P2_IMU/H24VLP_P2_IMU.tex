...
\newcommand{\thisDocRef}{\footnote{History of changes at \url{https://github.com/DfAC/TeachingSlides/tree/master/H24VLP_IMS}.}}
...
\begin{titlepage}
\title{\includegraphics[width=7cm]{./../logo.png}\vspace*{5cm}
\\
