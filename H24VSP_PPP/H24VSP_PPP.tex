		...
		\begin{minipage}[t]{\textwidth}%
			\resizebox{\columnwidth}{!}{%
				\begin{tabular}{lccccc} %{l|c|c|c|c}
					...
					\textbf{NGB5} & ITRF2014 & \textbf{52 57 7.07341} & \textbf{01 11 1.42740} W & \textbf{91.484} & at antenna PCO\footnote{Converted from ETRF97 to ITRF2014 at epoch 2017-12-06.} \\
					\textbf{NGB5} & ITRF2014 & \textbf{5257.1178902} & \textbf{0111.0237900} W & \textbf{91.484} & at antenna PCO\footnote{NEMEA GGA string DDMM.MMMMMMM format, eq to 0.0018 m.} \\		
					\bottomrule
				\end{tabular}%
			}
