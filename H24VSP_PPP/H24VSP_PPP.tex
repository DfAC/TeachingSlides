...
\begin{frame}{NGB5}
	\begin{table}
		...
		\begin{minipage}[t]{\textwidth}%
			\resizebox{\columnwidth}{!}{%
				\begin{tabular}{lccccc} %{l|c|c|c|c}
					...
					\textbf{NGB5} & ITRF2014 & \textbf{5257.1178589} & \textbf{0111.0237657} W & \textbf{91.486} & at antenna PCO\footnote{NEMEA GGA string DDMM.1234567 is eq to 0.0018 m.} \\		
					\bottomrule
				\end{tabular}%
			}
		...
		\end{minipage}
	\end{table}
	%in DDMM.1234567 is eq to 0.0018 m	
\end{frame}
