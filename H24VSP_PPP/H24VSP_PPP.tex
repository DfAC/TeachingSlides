...
\begin{frame}{NGB5}
		...
		\begin{minipage}[t]{\textwidth}%
			\resizebox{\columnwidth}{!}{%
				\begin{tabular}{lccccc} %{l|c|c|c|c}
					...
					\textbf{NGB5} & ITRF2014 & \textbf{52 57 7.07209} & \textbf{01 11 1.42505} W & \textbf{91.488} & at antenna PCO\footnote{Converted from ETRF97 to ITRF2014 at epoch 2018-12-05.} \\
					\textbf{NGB5} & ITRF2014 & \textbf{5257.117868} & \textbf{0111.023751} W & \textbf{91.488} & at antenna PCO\footnote{To calculate error in meters at latitude $\phi$ of NGI, use $(\lambda_{NMEA}-\lambda_{truth})*1800$ and $(\phi_{NMEA}-\phi_{truth})*1200$. The 6th decimal place of GGA string is equivalent to 1.8mm for N($\phi$) and 1.2mm for E($\lambda$).
} \\		
					\bottomrule
				\end{tabular}%
			}
	...
	\end{table}
\end{frame}
%in case of sec diference use 30m and 20m
% DDMM.123456
