...
Welcome to the second project of H24VLP Location Technology Practical\thisDocRef. We will focus on navigation applications of the Inertial Navigation Systems (INS)\footnote{For more informations check lectures or \url{https://en.wikipedia.org/wiki/Inertial_navigation_system}}, in our case consisting of integrated GNSS and inertial measurement unit (IMU) deployed on a moving platform (NGI Van). This practical learning outcomes are:
